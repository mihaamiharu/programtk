...
<p>Tanggal	: <?php echo $_GET['tgl1']; ?><br><br>Sampai	: <?php echo $_GET['tgl2']; ?></p>
<table width="100%" border="1" cellspacing="0" cellpadding="4">
	...
	<?php 
	$sqlBayar = mysqli_query($koneksi,"SELECT spp.*,siswa.nds,siswa.namasiswa,siswa.kelas FROM spp INNER JOIN siswa ON spp.idsiswa=siswa.idsiswa WHERE ket = 'BELUM LUNAS' AND jatuhtempo BETWEEN '$_GET[tgl1]' AND '$_GET[tgl2]' ");
	$no=1;
	$total = 0;
