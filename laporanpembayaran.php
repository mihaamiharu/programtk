...
<table width="100%" border="1" cellspacing="0" cellpadding="4">
	...
	<?php 
	$sqlBayar = mysqli_query($koneksi,"SELECT spp.*,siswa.nds,siswa.namasiswa,siswa.kelas FROM spp INNER JOIN siswa ON spp.idsiswa=siswa.idsiswa WHERE tglbayar BETWEEN '$_GET[tgl1]' AND '$_GET[tgl2]' ORDER BY tglbayar ASC");
	$no=1;
	$total = 0;
